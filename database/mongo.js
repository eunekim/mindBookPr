...
const getFamousWorks = async (category) => {
  ...
  try {
    ...
    const response = await axios.post('https://api.openai.com/v1/chat/completions', {
      ...
      headers: {
        'Authorization': `Bearer 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`,
